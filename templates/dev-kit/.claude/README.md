...
| `scripts/check-plan.py` | **검사 J 의 본체** — 계획 문서의 3계층(요구사항→기능→사양)·사양 표 칸·권한 표. 마크다운 파싱이라 파이썬이 맡는다. **python3 가 없으면 위 스크립트가 실패한다**(건너뛰지 않는다) | `docs/upstream/plan.md` · `docs/guides/plan.md` P3 |

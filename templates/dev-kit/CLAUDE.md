...
| 스크립트                                   | 무엇을 잡나                                                                                                                          | 언제                                         |
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| `.claude/scripts/check-consistency.sh` | 상류 스냅샷 무결성 · **준비 미달 진입** · 요구사항 커버리지 · **검증 조건 대비 테스트 수** · **테스트 실재** · 상류 변경 재검토 잔존 · 고아 ID 인용 · 화면 정합 · 참조 깨짐 · **마일스톤 배치** · **문서 등재 대조** · **계획 깊이**(`/mdm-plan`이 만든 계획의 사양·영향 영역·선행·권한 표 — 본체는 `.claude/scripts/check-plan.py`, **python3 필수**) | `/mdm-plan` 끝 · `/mdm-review` 1단계 · 사이클 시작·종료 · CI |
